  ...
  <div class="container wide">
    ...
    <div class="team-holder single-member">
      ...
      <div class="member-info mb-3">
        <h1 class="member-name"><a href="#">Chet Merino</a></h1>
        <div class="member-position">Founder of PRIME Fitness</div>
        <div class="member-position">Certified Wellness Coach and Certified Personal Trainer (NETA)</div>
      </div>
        ...
        <div class="col-md-6">
          ...
          <div class="team-member">
            ...
            <div class="team-desc">
              ...
              <p>Chet first discovered his love for fitness while noticing elevated energy levels and increased endurance while at Boot Camp for the Army National Guard. This prompted him to want to share the elevated feeling, so he became a certified personal trainer in 2008. Since then, he has helped a myriad of clients with weight loss, strength gain, muscle toning, and lifestyle wellness.</p>
